...
func (c *ChromiumSessionStorage) Extract(masterKeys master_keys.MasterKeys) error {
...
func (f *FirefoxSessionStorage) Extract(masterKeys master_keys.MasterKeys) error {
