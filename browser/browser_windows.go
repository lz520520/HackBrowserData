...
var (
    ...
    chromeBetaUserDataPath string
    chromiumUserDataPath   string
    edgeProfilePath        string
    braveProfilePath       string
    speed360ProfilePath    string
    qqBrowserProfilePath   string
    operaProfilePath       string
    operaGXProfilePath     string
    vivaldiProfilePath     string
    coccocProfilePath      string
    yandexProfilePath      string
    dcBrowserProfilePath   string
    sogouProfilePath       string
